...
- git 서버에서 프로젝트 git 폴더를 통째로 압축하여, 이전 서버 repos에 풀면 된다. (chown -R 로 git user 소유권 설정.)
- 위 방식이 제일 간단.
...
MTAsMTA5ODUzMTg3MywyNjE2ODgxOTYsLTU4NDU4OTE3NCwxOD
U5ODU3OTU4LDI5NTgyMDczNiwtMTE1MzQ0NjQyMSw3MzYyNTA3
MTFdfQ==
-->